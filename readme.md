#0. Curations
[Micro Learning](http://www.producthunt.com/@shilpink/collections/bite-sized-learning)

#1. React

* 하이브리드 렌더링 전략(React + Backbone) [2](http://funnygangstar.tistory.com/206)
* [React+d3.js with D3 Tips and Tricks](https://leanpub.com/b/reactd3tipsandtricks)
* [React on ES6+](http://babeljs.io/blog/2015/06/07/react-on-es6-plus/)
* [React.js Introduction For People Who Know Just Enough jQuery To Get By](http://reactfordesigners.com/labs/reactjs-introduction-for-people-who-know-just-enough-jquery-to-get-by/)
* [Cross-platform background geolocation module for React Native](http://www.reactnative.com/cross-platform-background-geolocation-module-for-react-native/)
* [react-loadscript](https://github.com/threepointone/react-loadscript) - script tag as a react component
...
* [**The State of Animation in React**](https://www.youtube.com/watch?v=1tavDv5hXpo)
* http://ronnqvi.st/multiple-animations/
* [Hot Loading Your ES6 React/Flux App with Webpack](http://ditrospecta.com/javascript/react/2015/07/23/react-flux-hot-load-webpack.html)
* Coderifleman – React.js를 이해하다 [4](http://blog.coderifleman.com/post/122771353444/react-js-4)
* [Reactive Frontend](http://mgonto.github.io/reactive-frontend-oscon/) - FRP에 대한 이야기가 아니라 FP에서 RP로 넘어가는 이야기.
...
* [Chart Component](http://jhudson8.github.io/react-chartjs/index.html)
* [Beautiful and expressive sparklines component for React](http://borisyankov.github.io/react-sparklines/)
* [React Motion + live reloading works like a breeze](http://twitter.com/jlongster/status/619266601662201856/photo/1)
* [React Animation](https://github.com/chenglou/react-animation)
...
[Airbnb의 리액트 컴포넌트 스타일 가이드.](https://github.com/airbnb/javascript/tree/master/react)
...
[ANNOUNCING DOCKER TOOLBOX](http://blog.docker.com/2015/08/docker-toolbox/)
...
## Tutorial
http://tutorial-viewer.meteor.com/tutorial/0/react - 이거 매우 훌륭. 같은 meteor 튜토리얼을 Blaze(default), Angular, React로 보여주는 사이트

[Multiplayer gaming with Meteor](https://www.youtube.com/watch?v=z0HMYEkB0QY&feature=youtu.be&list=PLTUf4ytkmI8S6FYUW2Fd5axHWXRkyg3lb&utm_content=18669328&utm_medium=social&utm_source=twitter)
...
* [Meteor: the missing infrastructure for building great React apps](http://info.meteor.com/blog/meteor-the-missing-infrastructure-for-building-great-react-apps?utm_campaign=Core%20Compete&utm_content=17404368&utm_medium=social&utm_source=twitter)
...
파이썬 초보 - pandas와 matplotlib을 활용한 간단 분석 [part1](http://jsideas.net/python/2015/08/10/histogram_tutorial.html) [part2](http://jsideas.net/python/2015/08/11/histogram_tutorial_part2.html)
...
* [CSS lighten/darken 과 mix 사이의 차이를 보여주는 삽화.](http://codepen.io/KatieK2/pen/tejhz/)
* [CSS 요소를 유형별 정렬하는 갈라로는 Concentric CSS라는 것이 있다고. Concentric CSS는 순서를 정의하기 위해 박스 모델에 의존한다. 스타일 시트를 참고하면 이해하기 쉬움. ](https://github.com/brandon-rhodes/Concentric-CSS/blob/master/style.css)
...
### vilolin plot
박스 플롯의 변종 [link1](http://bokeh.pydata.org/en/latest/docs/gallery/violin.html) [link2](http://stanford.edu/~mwaskom/software/seaborn/generated/seaborn.violinplot.html)


## libraries
[TimelineJS - 시간의 흐름을 네비게이션화](http://webdir.tistory.com/441)
